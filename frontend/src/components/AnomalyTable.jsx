      ...
      <div className="overflow-y-auto max-h-[calc(100vh-240px)]">
        <table className="w-full text-sm">
          <thead className="sticky top-0 bg-gray-800 border-b border-gray-700">
            <tr>
              <th className="text-left px-4 py-2 text-xs text-gray-400 font-medium">Session ID</th>
              <th className="text-left px-4 py-2 text-xs text-gray-400 font-medium">Severity</th>
              <th className="text-right px-4 py-2 text-xs text-gray-400 font-medium">Score</th>
              <th className="text-right px-4 py-2 text-xs text-gray-400 font-medium">Lines</th>
          ...
          <tbody>
            {sessions.map((s) => (
              ...
              >
                <td className="px-4 py-2.5 font-mono text-xs text-blue-300 max-w-[200px] truncate">
                  {s.session_id}
                </td>
                ...
                <td className="px-4 py-2.5 text-right">
                  {s.analyzed ? (
                    ...
                    <button
                      ...
                      className="text-xs px-2 py-1 rounded bg-blue-900/50 text-blue-300 hover:bg-blue-800/60 transition-colors disabled:opacity-50"
                    >
